...
Manual testing was done for the entire application. The results for each step of the application is stored in the tables below.

## Manual testing of start screen options. 

|Choice/ What is expected from user | Input | Expected result | Response |
|---|---|---|---|
